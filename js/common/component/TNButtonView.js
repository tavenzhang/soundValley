...
export class  TNButton extends PureComponent {
...
export default class TNButtonView extends PureComponent {
...
export  class TNButtonImg extends PureComponent {
    ...
    render() {
        ...
        return (
            <TNButton  {...this.props} containStyles={btnStyle}>
                <View style={{flexDirection:isHorizon ? "row":"column", justifyContent:"center",alignItems:"center"}}>
                <Image style={disabled ? imgStyleDisable:imgStyle}
